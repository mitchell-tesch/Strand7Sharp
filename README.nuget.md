<!--
    ...
    This file is the NuGet-flavored README (referenced by
    <PackageReadmeFile> in Strand7Sharp.csproj). Keep the body in sync with
    README.md — the only intentional difference is the header block below,
    which uses plain Markdown so it renders on nuget.org (nuget.org strips
    the HTML alignment tags used in README.md).
-->

![Strand7Sharp](https://raw.githubusercontent.com/mitchell-tesch/Strand7Sharp/main/assets/icon.png)
...
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://github.com/mitchell-tesch/Strand7Sharp/blob/main/LICENSE)
