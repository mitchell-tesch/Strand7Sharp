...
long St7GetReinforcementData(long uID, long LayoutID, long* Integers,
double* Doubles)
Input Parameters
uID
...
[ipRCUseMembraneThickness] – It btTrue, use plate element membrane thickness, otherwise use
