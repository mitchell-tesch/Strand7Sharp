# St7SetNumericOptions

Sets the display mode of numbers in the model window.

long St7SetNumericOptions(long uID, long Mode, long Style, long Digits,
...
The model window mode for which the numeric options are being assigned.  Either nmPreProcessing or
nmPostProcessing.
