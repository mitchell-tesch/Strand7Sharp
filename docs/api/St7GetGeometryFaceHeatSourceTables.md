...
Returns the tables associated with the heat source assigned to the specified geometry face. See also
St7GetEntityAttributeSequenceCount and St7GetEntityAttributeSequence.

long St7GetGeometryFaceHeatSourceTables(long uID, long FaceNum, long CaseNum,
long* Tables)
Input Parameters
uID
