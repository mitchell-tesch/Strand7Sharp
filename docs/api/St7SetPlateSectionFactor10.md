# St7SetPlateSectionFactor10

Sets the factors for the specified plate. Each stiffness factor scales the corresponding row and column in the
...
long St7SetPlateSectionFactor10(long uID, long PlateNum, double* Doubles)
