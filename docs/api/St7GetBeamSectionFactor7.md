...
Returns the factors for the specified beam. Each stiffness factor scales the corresponding row and column in the
...
long St7GetBeamSectionFactor7(long uID, long BeamNum, double* Doubles)
