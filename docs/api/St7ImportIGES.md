...
long St7ImportIGES(long uID, char* FileName, long* Integers, double* Doubles,
long Mode)
Input Parameters
uID
Strand7 model file ID.
FileName
Full path and name for the IGES file to be imported.
Integers[0..5]
...
btFalse.
[ipGeomImportGroupsAs] – Geometry groups import; one of ggNone, ggAuto, ggSubfigures or
ggLevels.
