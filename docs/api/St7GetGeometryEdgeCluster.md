# St7GetGeometryEdgeCluster

Returns the cluster type and ID on the edge. After automeshing, all nodes along edges with the same cluster type
and ID are connected according to the parameters.

long St7GetGeometryEdgeCluster(long uID, long EdgeNum, long* ClusterID,
