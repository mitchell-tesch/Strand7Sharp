...
long St7SetResFilePlateResult(long uID, long CaseNum, long PlateNum,
...
NonlinearMaterial
True if the results correspond to a material nonlinear analysis. This option can be set only for result files
of type stNonlinearStatic, stQuasiStatic and stNonlinearTransientDynamic.
Doubles[..]
