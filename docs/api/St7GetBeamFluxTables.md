...
Returns the tables associated with the heat flux for the specified beam end. See also
St7GetEntityAttributeSequenceCount and St7GetEntityAttributeSequence.

long St7GetBeamFluxTables(long uID, long BeamNum, long BeamEnd, long CaseNum,
long* Tables)
Input Parameters
uID
