...
Generates a line of nodes and/or beam elements around the circumference of a circle. The circle is
defined by three points on the circumference.

long St7PLCircleC3(long uID, double* P1, double* P2, double* P3, long NumSteps,
