...
Specifies the time tables to be associated with the base excitation components for linear and nonlinear transient
dynamic analysis.

long St7SetTransientBaseTables(long uID, long BaseType, long* Integers)
