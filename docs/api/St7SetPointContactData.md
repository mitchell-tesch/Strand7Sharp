...
long St7SetPointContactData(long uID, long PropNum, long* Integers,
...
[ipTensionLateralStiffness] – Use lateral stiffness with ctTension elements; either btTrue or
btFalse.
