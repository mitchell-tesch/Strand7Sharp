...
Returns the tables associated with the convection coefficient assigned to the specified geometry face surface. See
also St7GetEntityAttributeSequenceCount and St7GetEntityAttributeSequence.

long St7GetGeometryFaceConvectionTables(long uID, long FaceNum, long CaseNum,
